...
@Entity
public class datosMascotas implements Serializable {
    ...
    public datosMascotas(int num_cliente, String nombre_perro, String raza, String color, String alergico, String atención_especial, String nombre_duenio, int celular_duenio, String observaciones) {
